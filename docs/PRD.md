...
- **2026-08-23**: menjawab open decision 17.2 soal kapan Fase 1 Section 9A mulai dikerjakan relatif terhadap P1 hardening (N7–N11) — pemilik produk mengunci rekomendasi: **F2–F6 Section 9A (section kit, `SectionRenderer`, Designer Studio kanvas, gate otomatis, konsol admin katalog, profil publik designer) ditunda seluruhnya**, tidak dikerjakan sampai ada sinyal demand designer nyata (bukan asumsi) — §9A.10 sudah mencatat ini sebagai risiko, keputusan ini menegaskannya jadi syarat mulai, bukan cuma catatan risiko. **Hanya F1 (model konten kanonik) ditarik maju**, sebagai proyek berdiri sendiri lepas dari marketplace, karena nilainya independen: menutup isu profil ganda (Section 10) yang sudah bocor di v1, bukan cuma prasyarat Fase 2. Urutan pengerjaan F1 tetap **setelah** v1 launch selesai (termasuk P1 hardening N7–N11 yang tetap wajib sebelum go-live, lihat entri 2026-08-21 di atas) — bukan konkuren dengan N7–N11, dan bukan sebelumnya; ini pivot yang berbeda dari pivot designer-001 2026-08-21 yang justru mendahulukan kerja Designer Portal. Gate verifikasi F1 tetap seperti tercatat di §9A.9: user pindah template `corporate ↔ minimal` tanpa field hilang, dibuktikan tes. Tabrakan nama tabel `templates` (katalog v1 `is_active` vs `templates`/`template_versions` baru di §9A.8) **belum diselesaikan di sini** — diputuskan saat F1 benar-benar mulai dikerjakan, bukan sekarang.
...
- ~~Kapan Fase 1 Section 9A (model konten kanonik) mulai dikerjakan relatif terhadap P1 hardening (N7–N11)~~ — **terjawab 2026-08-23, lihat Section 17.1**: F1 ditarik maju sebagai proyek berdiri sendiri tapi urutannya tetap setelah v1 launch/N7–N11, bukan konkuren; F2–F6 (marketplace) ditunda sampai ada sinyal demand designer nyata.
