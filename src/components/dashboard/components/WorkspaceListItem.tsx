    ...
    <tr className="group transition-colors hover:bg-shell/50">
        ...
        <div className="flex items-center gap-3.5">
          <div className="relative h-11 w-14 shrink-0 overflow-hidden rounded-lg bg-shell ring-1 ring-black/5 shadow-2xs">
            {workspace.preview ? (
              ...
              <div className="flex h-full w-full items-center justify-center bg-shell text-ink-faint">
      ...
      <td className="px-6 py-4 text-right whitespace-nowrap">
        <div className="flex items-center justify-end gap-1.5">
          ...
          <Link
            href={`/dashboard/${workspace.id}/editor`}
            className="inline-flex h-8 items-center gap-1.5 rounded-full bg-accent/[0.08] px-3 text-[12px] font-bold text-accent-deep ring-1 ring-accent/20 transition-all duration-200 hover:bg-accent hover:text-white active:scale-[0.98]"
          >
          ...
          <div className="relative inline-block text-left">
            ...
            {openMenu && (
              <>
                ...
                <div className="absolute right-0 top-full z-30 mt-1 flex w-48 flex-col overflow-hidden rounded-xl bg-surface p-1 shadow-floating ring-1 ring-black/5 animate-fade-in-up-custom text-left">
                  <Link
                    href={`/dashboard/${workspace.id}/editor`}
