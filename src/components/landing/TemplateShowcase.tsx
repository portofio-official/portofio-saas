    ...
    <section className={styles.templateShowcase} id="templates" data-landing-section>
      ...
      {previewId && (
        <div className="fixed inset-0 z-50 flex flex-col bg-black/80 backdrop-blur-md transition-all animate-fadeIn">
          {/* Header Bar */}
          <div className="flex h-16 shrink-0 items-center justify-between gap-3 border-b border-black/10 bg-white px-3 sm:px-6 shadow-sm z-10">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="flex min-w-0 items-center gap-2.5">
                <span className="truncate font-display text-base font-bold text-gray-900">
                  {TEMPLATES.find((m) => m.id === previewId)?.name}
                </span>
                <span className="shrink-0 rounded-full bg-black/[0.05] px-2.5 py-0.5 text-[11px] font-medium text-gray-600">
                  Live Preview
                </span>
              </div>
            </div>
            ...
            <button
              ...
              className="flex shrink-0 items-center gap-2 rounded-full bg-[#00cf7c] px-4 sm:px-6 py-2.5 text-xs font-bold text-white shadow-md transition-all hover:bg-[#00b86e] active:scale-95"
            >
